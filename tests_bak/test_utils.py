...
from postgkeyll.gk.gk_utils import get_block_indices, parse_slice_string, read_gfile
from postgkeyll.utils.input_parser import input_parser
...
class TestVerbPrint:
    def test_verb_print_verbose_true(self, capsys):
        from postgkeyll.utils.verb_print import verb_print
...
class TestLoadStyle:
    def test_load_style_simple_key(self, tmp_path):
        from postgkeyll.utils.load_style import load_style
